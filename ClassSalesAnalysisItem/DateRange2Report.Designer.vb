Partial Class DateRange2Report
    ...
    Private Sub InitializeComponent()
        ...
        Me.TextBox8.Location = New Telerik.Reporting.Drawing.PointU(Telerik.Reporting.Drawing.Unit.Inch(7.0386509895324707R), Telerik.Reporting.Drawing.Unit.Inch(0.000039418537198798731R))
    ...
    " "" + Format(""{0:MM/dd/yyyy}"",Parameters.dEndDate.Value.Date) "
        ...
        Me.Filters.Add(New Telerik.Reporting.Filter("=Fields.sales_rep_assoc_nbr", Telerik.Reporting.FilterOperator.[In], "=Parameters.dSalesmanNBR.Value"))
